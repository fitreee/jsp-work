...
<style>
	...
	.card-body{
		background-color: rgb(8, 179, 107);
		color: #ffff;
	}
	p{
		color: #ffff;
...
<body class="bg-light">
			...
			<div class="card-body">
				<div class="row text-center pt-4">
					<div class="col-lg-4 pb-4">
						<img alt="อิฟฟาน ยูโซ๊ะ" class="rounded-circle shadow" width="140" height="140" src="assets/img/iffan.jpg" />
						<h5 class="pt-4 mb-3">ผู้พัฒนาระบบ</h5>
						<h2>อิฟฟาน ยูโซ๊ะ</h2>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010003</p>
						<p class="pt-3"><a class="btn btn-primary" href="https://www.facebook.com/iffanyusoh.lfcynwa" role="button"><i class="fab fa-facebook-square"></i>&nbsp; @Iffān S. Yūsóh</a></p>
					</div>
					<div class="col-lg-4 pb-4">
						<img alt="ฟิตรี ดอเฮ็ง" class="rounded-circle shadow" width="140" height="140" src="assets/img/fitree.jpg" />
						<h5 class="pt-4 mb-3">ผู้พัฒนาระบบ</h5>
						<h2>ฟิตรี ดอเฮ็ง</h2>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010007</p>
						<p class="pt-3"><a class="btn btn-primary" href="https://www.facebook.com/fitree.doheng.16" role="button"><i class="fab fa-facebook-square"></i>&nbsp; @Fitree Doheng</a></p>
					</div>
					<div class="col-lg-4 pb-4">
	...
	<p class="mt-4 small text-muted text-center">&copy; 2019 FitChiwwr</p>
