...
<body class="bg-light">
	...
	<main role="main" class="container">
		...
		<div style="background-color:rgb(8, 179, 107);text-align:center;padding:30px;margin-top:7px;
		height: 85px;border-radius: 2%;color:white;"> <h5>
		<marquee >บางครั้ง "เวรกรรม" มาในรูปแบบ โปรเจค!!!        
			 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;              
			 ชีวิตติด Bug ความรักก็เลยติด Error    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;              |    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
			            โปรเจคนะทำได้ แต่โปรเจคยากนะ เหนื่อยใจ!!!</marquee></h5></div>
	</main>
	<p class="mt-5 small text-muted text-center">&copy; 2019 FitChiww</p>
