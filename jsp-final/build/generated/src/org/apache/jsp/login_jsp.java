...
if ("POST".equalsIgnoreCase(request.getMethod())) {
	...
	try {
      ...
      out.write("<style>\n");
      out.write("\t.bg{\n");
      out.write("\t\tbackground-image: url(\"assets/img/bg.png\");\n");
      out.write("\t}\n");
      out.write("\t.btn{\n");
      out.write("\t\tbackground-color: #E01212;\n");
      out.write("\t}\n");
      out.write("\t.btn:horver{\n");
      out.write("\t\tbackground-color:  #11B200;\n");
      out.write("\t}\n");
      out.write("\t.mt-2{\n");
      out.write("\t\tcolor:#ffff;\n");
      out.write("\t}\n");
      out.write("\ta{\n");
      out.write("\t\tcolor:#E01212;\n");
      out.write("\t}\n");
      out.write("\th1{\n");
      out.write("\t\tcolor:#ffff;\n");
      out.write("\t}\n");
      ...
      out.write("            <h1 class=\"h3 mb-2 font-weight-normal\">Welcome</h1>\n");
      out.write("            <p>กรุณาลงชื่อเข้าใช้</p>\n");
      out.write("        </div>\n");
      out.write("\t\t");
 ...
 if (request.getParameter("remember_me") != null) { out.print("checked"); } 
      ...
      out.write("        <p class=\"mt-3 small text-muted text-center\">&copy; 2019 FitChiww</p>\n");
      out.write("    </form>\n");
